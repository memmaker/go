...
type LoopConfig struct {
    ...
    ProcessInputFunc func() (terminationCode int)
...
func CreateLoop(c LoopConfig, terminationCode *int) func() {
    ...
    return func() {
        ...
        for *terminationCode = 0; *terminationCode == 0; {
            ...
            *terminationCode = c.ProcessInputFunc()
