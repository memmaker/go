...
func SaveZones(filename string, zones map[string]map[geometry.Point]bool) error {
...
func ReadZones(filename string) map[string]map[geometry.Point]bool {
	...
	var zones = make(map[string]map[geometry.Point]bool)
	...
	for i := 0; i < int(zoneCount); i++ {
		...
		zone := make(map[geometry.Point]bool)
...
func sortedValues(zone map[geometry.Point]bool) []geometry.Point {
...
func sortedNames(zones map[string]map[geometry.Point]bool) []string {
